...
model.addAttribute("topList", topList);
        ...
        int totalStoreCount = restaurantService.getTotalCount();
        model.addAttribute("totalStoreCount", totalStoreCount);
...
@GetMapping("/mybookmarkList")
    ...
    public String mybookmarkList() { return "mypage/mybookmarkList"; }
...
@@ -65,34 +59,22 @@ public String detail(@RequestParam("id") String id, Model model) {
return "store/detail";
}
